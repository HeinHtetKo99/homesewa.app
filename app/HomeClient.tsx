...
export default function HomeClient() {
  ...
  return (
    <div className="w-full font-sans text-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-6 pb-10 sm:py-16 flex flex-col md:flex-row items-center gap-4 md:gap-16">
          ...
          <div className="w-full md:w-1/2">
            <div className="relative w-full overflow-hidden rounded-3xl shadow-2xl border border-teal-100 bg-gray-50">
              <Image
                src="/home/hero.jpg"
                alt="HomeSewa — professional on-demand home services in Kathmandu, Nepal"
                width={1024}
                height={512}
      ...
      {/* PARTNERS */}
      <section className="py-10 bg-gray-50 overflow-hidden" aria-label="Partner organizations">
        <div className="flex gap-12 animate-scroll whitespace-nowrap">
          {Array.from({ length: 14 }, (_, i) => (
            <img key={i} src={`/partners/${i + 1}.png`} alt={`HomeSewa partner ${i + 1}`} className="h-12 opacity-70" />
          ))}
          {Array.from({ length: 14 }, (_, i) => (
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative group">
              <img
                src="/about/about.png"
                alt="About HomeSewa team and services in Nepal"
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
          {testimonials.map((t) => (
            <div key={t.name} className="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center hover:shadow-xl transition-shadow border border-teal-100">
              ...
              <h3 className="text-teal-800 font-bold text-lg">{t.name}</h3>
            </div>
          ))}
        </div>
      </section>
